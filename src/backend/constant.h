...
#define BUFLEN sizeof(struct shinyarmor_hdr) + 20  /* BUG: magic number is 14 here, anything len below 14 will cause errno of invalid argument to system call for some reason. */
